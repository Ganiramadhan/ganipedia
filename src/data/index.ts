...
export const portfolios: Portfolio[] = [
  ...
  },
  {
    ...
    description: 'Platform e-commerce modern untuk startup teknologi. Dilengkapi dengan payment gateway terintegrasi (Midtrans), inventory management real-time, customer dashboard, sistem review & rating, dan analytics penjualan komprehensif.',
  ...
  },
  {
    ...
    description: 'Sistem Point of Sale berbasis web untuk UMKM. Fitur kasir dengan barcode scanner, manajemen stok otomatis, laporan penjualan harian/bulanan, multi-user access, dan integrasi printer thermal untuk struk.',
  ...
  },
  {
    ...
    description: 'Website portfolio kreatif untuk studio desain grafis. Menampilkan galeri project interaktif dengan animasi smooth, testimonial klien, blog untuk sharing insights, dan sistem booking konsultasi online.',
  ...
  },
  {
    ...
    description: 'Learning Management System untuk platform edukasi online. Dilengkapi video streaming, quiz interaktif, progress tracking, certificate generation, discussion forum, dan payment system untuk course berbayar.',
    technologies: ['Next.js', 'AWS S3', 'PostgreSQL', 'Redis', 'WebRTC'],
  },
];
